...
public class SearchHistoryRecyclerViewAdapter extends RecyclerView.Adapter<SearchHistoryRecyclerViewAdapter.ViewHolder> {
    ...
    private final OnSearchHistoryFragmentInteractionListener mListener;

    public SearchHistoryRecyclerViewAdapter(List<DummyItem> items, OnSearchHistoryFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.OnSearchHistoryFragmentInteraction(holder.mItem);
                }
            }
        });
    }
